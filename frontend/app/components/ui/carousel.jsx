...
const Carousel = React.forwardRef(({ orientation = "horizontal", opts, setApi, plugins, className, children, ...props }, ref) => {
  ...
  const orientationValue = orientation || (opts?.axis === "y" ? "vertical" : "horizontal");
  ...
  const providerValue = React.useMemo(
    ...
    [carouselRef, api, opts, orientationValue, scrollPrev, scrollNext, canScrollPrev, canScrollNext],
  );
